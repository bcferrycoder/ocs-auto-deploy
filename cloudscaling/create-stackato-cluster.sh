...
STACKATO_CORE_NAME=api.208.75.128.187.xip.io
STACKATO_CORE_INTERNAL_IP=10.12.0.42
...
for INSTANCE_IP in `cat /tmp/newinstanceips.txt` ; do echo "adding $INSTANCE_IP to cluster"; ssh -o "StrictHostKeyChecking no"  $STACKATO_CORE_NAME "ssh -o 'StrictHostKeyChecking no' $INSTANCE_IP \"sudo /home/stackato/bin/kato attach -e dea $STACKATO_CORE_INTERNAL_IP\""; done
